...
//Modified code based on the following repository:
...
public class FalconPathPlanner
{
	 ...
	 * @throws Exception 
	 */
	public FalconPathPlanner(double[][] path, double[] headings) throws Exception{
		if(path.length < 2){
		...
		this.origPath = doubleArrayCopy(corrected);
